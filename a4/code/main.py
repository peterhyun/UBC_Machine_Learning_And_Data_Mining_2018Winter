...
if __name__ == "__main__":
    ...
    if question == "2":
        ...
        model = linear_model.logLinearClassifier(verbose=0, maxEvals=500)
        model.fit(XMulti, yMulti)
        ...
        # TODO
        model = LogisticRegression(multi_class='multinomial', solver='lbfgs', fit_intercept = False, C=430353535)
        model.fit(XMulti, yMulti)
